		...
		<>
			<div className="flex justify-between bg-gradient-to-br from-[#1e3a5f] to-slate-900 text-white px-2 py-4 w-full">
				...
				<div className="flex items-center mr-4 gap-4">
					...
					<Link href="/dashboard/settings" className="hover:text-[#39CCCC] transition-colors p-1 hover:bg-slate-800 rounded">
			...
			<div className={`${lusitana.className} font-bold grid grid-cols-1 md:grid-cols-2 gap-4 p-6`}>
				<Link href="/dashboard/lists/newList">
					<div className="text-white h-[80px] rounded-2xl hover:border-[#39CCCC] hover:text-[#001F3F] pt-4 pl-4 flex transition-colors" style={{ backgroundColor: 'rgba(71, 85, 105, 0.85)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(241, 245, 249, 0.18)' }}>

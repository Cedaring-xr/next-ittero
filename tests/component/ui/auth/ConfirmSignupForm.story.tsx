...
export function ConfirmSignupFormWrapper({ showError = false }: { showError?: boolean }) {
	const [errorMessage] = useState(showError ? 'Invalid code' : undefined)
	...
	return (
		<form onSubmit={handleSubmit} className="space-y-3">
			<div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
				<h1 className="font-lusitana mb-3 text-2xl">Please confirm your account.</h1>
